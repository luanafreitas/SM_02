  ...
  return (
    <View style={styles.footerContainer}>
      <TouchableOpacity
        ...
        onPress={() => navigateFn('HomeScreen')}>
        <View>
          <SimpleLineIcons name="home" size={20} color="#0077FF" />
          <Text
            style={{
              color: name === 'HomeScreen' ? '#4e4eff' : 'black',
            }}></Text>
        </View>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        style={styles.footerItem}
        onPress={() => navigateFn('AppList')}>
        <View style={styles.footerItem}>
          <AntDesign name="book" size={20} color="#0077FF" />
          <Text
            style={{ color: name === 'AppList' ? '#4e4eff' : 'black' }}></Text>
        </View>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.footerItem}
        onPress={() => navigateFn('AppForm')}>
        <View style={styles.footerItem}>
          <Ionicons name="add-circle-outline" size={24} color="#0077FF" />
          <Text
            style={{ color: name === 'AppForm' ? '#4e4eff' : 'black' }}></Text>
        </View>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.footerItem}
        onPress={() => navigateFn('AppNot')}>
        <View style={styles.footerItem}>
          <Ionicons name="notifications-outline" size={21} color="#0077FF" />
          <Text
            style={{ color: name === 'AppNot' ? '#4e4eff' : 'black' }}></Text>
        </View>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.footerItem}
        onPress={() => navigateFn('ProfileScreen')}>
        <View style={styles.footerItem}>
